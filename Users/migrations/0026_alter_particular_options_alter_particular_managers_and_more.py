...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Users', '0025_alter_particular_nacimiento'),
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='particular',
            name='nacimiento',
            field=models.DateField(default=datetime.datetime(2006, 6, 22, 16, 59, 38, 382882, tzinfo=datetime.timezone.utc), verbose_name='Fecha nacimiento'),
        ),
    ]
